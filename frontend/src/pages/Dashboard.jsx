...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f6f0] flex justify-center px-6 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          <div className="bg-white rounded-2xl p-4 text-center shadow-sm">
            ...
            <p className="text-xs text-[#9c8572]">day streak</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 text-center shadow-sm">
            <p className="text-2xl">🌿</p>
            <p className="text-xl font-medium text-[#5c4a3a]">{user.gardenStage}</p>
